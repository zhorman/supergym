...
require("./modules/slider/slider-feedback");
var _initAccordion = require("./modules/accordion/init-accordion");
require("./modules/about-video/about-video");
require("./modules/accordion-button/accordion-button");
// ---------------------------------
...
},{"./modules/about-video/about-video":2,"./modules/accordion-button/accordion-button":3,"./modules/accordion/init-accordion":5,"./modules/form-validate/form":7,"./modules/modals/init-modals":13,"./modules/slider/slider":16,"./modules/slider/slider-feedback":15,"./modules/tabs/init-tabs":17,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";

var playButton = document.querySelector('.about__video-button');
var video = document.querySelector('.about__video-content');
...
var swiper = new _swiper.default('.feedback__swiper', {
  // Настройки слайдера
  slidesPerView: 1,
  loop: false,
  navigation: {
